...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/titan-group/beego/orm.PostTags)"`
}
...
go get -u github.com/titan-group/beego/orm
...
go test -v github.com/titan-group/beego/orm
