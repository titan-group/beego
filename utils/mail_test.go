...
func TestMail(t *testing.T) {
	config := `{"username":"titan-group@gmail.com","password":"titan-group","host":"smtp.gmail.com","port":587}`
	mail := NewEMail(config)
	if mail.Username != "titan-group@gmail.com" {
		t.Fatal("email parse get username error")
	}
	if mail.Password != "titan-group" {
